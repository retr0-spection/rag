...
Revision ID: 5c73ac5849ec
Revises: 
Create Date: 2024-09-15 00:51:12.872481
...
def upgrade() -> None:
    ...
    op.drop_table('files')
    op.drop_index('ix_context_history_id', table_name='context_history')
...
def downgrade() -> None:
    ...
    op.create_index('ix_context_history_id', 'context_history', ['id'], unique=False)
